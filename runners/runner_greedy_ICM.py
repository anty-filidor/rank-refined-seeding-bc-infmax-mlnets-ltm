...
def parameter_space(protocols, probability, networks):
    nets = [(n, load_network(n)) for n in networks]  # network name, network
    return itertools.product(protocols, probability, nets)
...
def run_experiments(config):
    ...
    for idx, investigated_case in enumerate(p_bar):
        ...
        probability = investigated_case[1]
        ...
        while (100 * len(greedy_ranking) / actors_num) <= seed_max_budget:
            ...
            for actor in available_actors:
                ...
                micm = nd.models.MICModel(
                    ...
                    seeding_budget=(100 - eval_seed_budget, eval_seed_budget,0),
